...
const togglePlatform = (id: string) =>
  setSelectedPlatforms((prev) =>
    ...
    <div className="flex flex-col lg:flex-row gap-6 h-full">
      {/* --Compose panel--*/}
      <div className="w-full lg:wh-[460px] shrink-0">
      ...
      >
        <p.icon className="size-4.5" />
            ...
            {/* Media upload */}
                ...
                <div>
                  <label className="block text-xs text-slate-500 uppercase mb-2">Media (optional)
                  ...
                  {mediaFile ? (
                    ...
                    <label  className="flex items-center justify-center gap-2 p-5 py-10 border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border:border-red-300 hover:bg-red-50/30 transition-all group">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <div  className="relative">
                      ...
                      <input type="date" required className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-b-lg text-slate-900 text-sm outline-none" value={scheduledDate} onChange={(e)=>setScheduledDate(e.target.value)} />
                ...
                <div  className="relative">
                      ...
                      <input type="time" required className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-b-lg text-slate-900 text-sm outline-none" value={scheduledTime} onChange={(e)=>setScheduledTime(e.target.value)} />
